...
from code.Const import C_WHITE, MENU_OP, EVENT_ENEMY, SPAWN_TIME, C_GREEN, C_CYAN
    ...
    def run(self):
        ...
        while True:
            ...
            for ent in self.entity_list:
                ...
                if ent.name == 'Player2':
                    self.level_text(24, f'Player1 - Health: {ent.health} | Score: {ent.score}', C_CYAN, (10, 45))
